<aside :class="[
    ...
    <nav class="flex-1 p-2 space-y-1 overflow-y-auto" :class="sidebarOpen ? 'p-4 space-y-2' : 'p-2 space-y-1'">
        ...
        @if(auth()->user()->role->value === 'admin')
            ...
            <a href="{{ route('admin.services.index') }}" class="flex items-center gap-2 px-3 py-2 rounded-lg transition-colors text-sm hover:bg-gray-100 {{ request()->routeIs('admin.services.*') ? 'bg-blue-600 text-white hover:bg-blue-700 hover:text-white shadow-md' : 'text-gray-700' }}">
